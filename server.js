...
const BANK = [
  ...
  /* ---------------------------- PAT & ING ---------------------------- */
  // ---- 🎭 ไหวพริบ ----
  { topic:"pat_ing", cat:"🎭 ไหวพริบ", diff:"easy", text:"ถ้าคุณกำลังวิ่งแข่ง แล้วแซงคนที่อยู่อันดับ 2 คุณจะอยู่อันดับไหน?", options:["อันดับ 1","อันดับ 2","อันดับ 3","อันดับสุดท้าย"], correctIndex:1 },
  { topic:"pat_ing", cat:"🎭 ไหวพริบ", diff:"hard", text:"อะไรมีฟันเยอะมาก แต่ไม่เคยกัดใคร?", options:["จระเข้","หวี","ฉลาม","คนโมโห"], correctIndex:1 },
  { topic:"pat_ing", cat:"🎭 ไหวพริบ", diff:"medium", text:"อะไรเอ่ย มีหน้าแต่ไม่มีตา มีมือแต่ไม่มีแขน?", options:["นาฬิกา","คน","หุ่นยนต์","ตุ๊กตา"], correctIndex:0 },
  { topic:"pat_ing", cat:"🎭 ไหวพริบ", diff:"easy", text:"อะไรยิ่งเติมยิ่งว่าง?", options:["กระเป๋า","หลุม","แก้วน้ำ","ตู้เย็น"], correctIndex:1 },
  { topic:"pat_ing", cat:"🎭 ไหวพริบ", diff:"hard", text:"อะไรยิ่งแบ่ง ยิ่งมีมากขึ้น?", options:["เงิน","ความรัก","เค้ก","ความรู้"], correctIndex:3 },
  { topic:"pat_ing", cat:"🎭 ไหวพริบ", diff:"easy", text:"ถ้าคุณมีเทียน 10 เล่ม ลมพัดดับไป 3 เล่ม เหลือเทียนกี่เล่ม?", options:["7","3","10","0"], correctIndex:2 },
  { topic:"pat_ing", cat:"🎭 ไหวพริบ", diff:"medium", text:"ถ้าคุณซื้อรองเท้าคู่หนึ่งราคา 1,000 บาท คุณจะได้รองเท้ากี่ข้าง?", options:["1","2","1,000","แล้วแต่ร้าน"], correctIndex:3 },
  { topic:"pat_ing", cat:"🎭 ไหวพริบ", diff:"easy", text:"อะไรยิ่งกินยิ่งผอม?", options:["คน","ไฟ","แมว","นักกีฬา"], correctIndex:1 },
  { topic:"pat_ing", cat:"🎭 ไหวพริบ", diff:"medium", text:"ถ้าคุณเดิน 10 ก้าวไปข้างหน้า แล้วเดินกลับมา 10 ก้าว คุณเดินทั้งหมดกี่ก้าว?", options:["10","20","0","แล้วแต่ความยาวก้าว"], correctIndex:1 },
  { topic:"pat_ing", cat:"🎭 ไหวพริบ", diff:"easy", text:"ถ้าคุณเห็นคำว่า “ห้ามอ่านข้อนี้” คุณควรทำอย่างไร?", options:["หยุดอ่าน","อ่านต่อ","หลับตา","ปิดเกม"], correctIndex:1 },

  // ---- 🔢 ตัวเลข & เวลา ----
  { topic:"pat_ing", cat:"🔢 ตัวเลข & เวลา", diff:"medium", text:"เดือนอะไรมี 28 วัน?", options:["กุมภาพันธ์","มกราคม","ทุกเดือน","เดือนที่ไม่มีเงิน"], correctIndex:2 },
  { topic:"pat_ing", cat:"🔢 ตัวเลข & เวลา", diff:"easy", text:"มีปลา 5 ตัวอยู่ในตู้ ตายไป 2 ตัว เหลือปลากี่ตัว?", options:["3","2","5","0"], correctIndex:2 },
  { topic:"pat_ing", cat:"🔢 ตัวเลข & เวลา", diff:"medium", text:"ไข่ 6 ฟอง ทำแตก 2 ฟอง ทอด 2 ฟอง และกิน 2 ฟอง เหลือไข่กี่ฟอง?", options:["0","2","4","6"], correctIndex:1 },
  { topic:"pat_ing", cat:"🔢 ตัวเลข & เวลา", diff:"medium", text:"ถ้าคุณนอนตอน 4 ทุ่มและตื่น 6 โมงเช้า คุณนอนกี่ชั่วโมง?", options:["6","8","10","12"], correctIndex:1 },
  { topic:"pat_ing", cat:"🔢 ตัวเลข & เวลา", diff:"medium", text:"ถ้ามีคน 10 คนอยู่ในห้อง แล้วไฟดับ เหลือกี่คน?", options:["0","5","10","มองไม่เห็นเลยไม่รู้"], correctIndex:2 },
  { topic:"pat_ing", cat:"🔢 ตัวเลข & เวลา", diff:"medium", text:"ถ้าไก่ตัวหนึ่งออกไข่วันละ 1 ฟอง 10 วันจะได้กี่ฟอง?", options:["1","5","10","ไก่ตัวผู้ไม่ออกไข่"], correctIndex:3 },
  { topic:"pat_ing", cat:"🔢 ตัวเลข & เวลา", diff:"easy", text:"ถ้าคุณมีเงิน 100 บาท ใช้ไป 100 บาท คุณเหลืออะไร?", options:["0 บาท","เงินทอน","ความสุข","ประสบการณ์"], correctIndex:0 },
  { topic:"pat_ing", cat:"🔢 ตัวเลข & เวลา", diff:"hard", text:"อะไรยิ่งเอาออกยิ่งใหญ่ขึ้น?", options:["เงิน","หลุม","เค้ก","บ้าน"], correctIndex:1 },
  { topic:"pat_ing", cat:"🔢 ตัวเลข & เวลา", diff:"easy", text:"คุณมีแอปเปิล 3 ลูก แล้วหยิบไป 2 ลูก ตอนนี้คุณมีแอปเปิลกี่ลูก?", options:["1","2","3","0"], correctIndex:1 },
  { topic:"pat_ing", cat:"🔢 ตัวเลข & เวลา", diff:"medium", text:"ถ้าคุณกำลังเล่นเกมแล้วเกมค้าง สิ่งแรกที่ควรทำคืออะไร?", options:["เตะคอม","ทุบโต๊ะ","รอหรือเช็กเกม","โทษแพต"], correctIndex:2 },

  // ---- 🧩 ปริศนาคำ ----
  { topic:"pat_ing", cat:"🧩 ปริศนาคำ", diff:"hard", text:"รถไฟฟ้าวิ่งไปทางเหนือ ควันจะลอยไปทางไหน?", options:["เหนือ","ใต้","ตะวันออก","ไม่มีควัน"], correctIndex:3 },
  { topic:"pat_ing", cat:"🧩 ปริศนาคำ", diff:"medium", text:"อะไรเอ่ย ยิ่งใช้ยิ่งสั้น?", options:["ดินสอ","เชือก","ถนน","บ้าน"], correctIndex:0 },
  { topic:"pat_ing", cat:"🧩 ปริศนาคำ", diff:"hard", text:"อะไรที่ยิ่งเปิดยิ่งมืด?", options:["ไฟ","ประตู","ร่ม","ตา"], correctIndex:2 },
  { topic:"pat_ing", cat:"🧩 ปริศนาคำ", diff:"hard", text:"อะไรเอ่ย ยิ่งตัดยิ่งยาว?", options:["ผม","เชือก","ถนน","กระดาษ"], correctIndex:2 },
  { topic:"pat_ing", cat:"🧩 ปริศนาคำ", diff:"medium", text:"อะไรมีตาแต่ไม่สามารถมองเห็น?", options:["เข็ม","คนหลับ","ปลา","กล้อง"], correctIndex:0 },
  { topic:"pat_ing", cat:"🧩 ปริศนาคำ", diff:"hard", text:"อะไรมีหัวแต่ไม่มีสมอง?", options:["คน","ตะปู","ปลา","ครูตอนวันจันทร์"], correctIndex:1 },
  { topic:"pat_ing", cat:"🧩 ปริศนาคำ", diff:"hard", text:"อะไรมีปีกแต่บินไม่ได้?", options:["นก","เครื่องบิน","โต๊ะปิกนิก","เพนกวิน"], correctIndex:3 },
  { topic:"pat_ing", cat:"🧩 ปริศนาคำ", diff:"easy", text:"อะไรมีลิ้นแต่พูดไม่ได้?", options:["คน","รองเท้า","งู","แมว"], correctIndex:1 },
  { topic:"pat_ing", cat:"🧩 ปริศนาคำ", diff:"easy", text:"อะไรมีรูเต็มไปหมด แต่ยังเก็บน้ำได้?", options:["ตะแกรง","ฟองน้ำ","กระชอน","ถุงพลาสติก"], correctIndex:1 },
  { topic:"pat_ing", cat:"🧩 ปริศนาคำ", diff:"hard", text:"อะไรอยู่ข้างหน้าเราเสมอ แต่เราไม่มีวันมองเห็น?", options:["อดีต","อนาคต","เพื่อน","คนที่เดินตาม"], correctIndex:1 },

  // ---- 😏 กวนประสาท ----
  { topic:"pat_ing", cat:"😏 กวนประสาท", diff:"easy", text:"พ่อของสมชายมีลูก 3 คน คนแรกชื่อหนึ่ง คนที่สองชื่อสอง แล้วคนที่สามชื่ออะไร?", options:["สาม","สมชาย","สมหญิง","ไม่รู้"], correctIndex:1 },
  { topic:"pat_ing", cat:"😏 กวนประสาท", diff:"medium", text:"อะไรมีคอแต่ไม่มีหัว?", options:["เสื้อ","คน","ขวด","ยีราฟ"], correctIndex:2 },
  { topic:"pat_ing", cat:"😏 กวนประสาท", diff:"hard", text:"อะไรมีขา 4 ขา แต่เดินไม่ได้?", options:["แมว","หมา","โต๊ะ","ม้า"], correctIndex:2 },
  { topic:"pat_ing", cat:"😏 กวนประสาท", diff:"easy", text:"อะไรอยู่กลางทะเล แต่ไม่เปียก?", options:["ปลา","เรือ","ตัวอักษร “ล”","คนว่ายน้ำ"], correctIndex:2 },
  { topic:"pat_ing", cat:"😏 กวนประสาท", diff:"medium", text:"อะไรยิ่งวิ่งยิ่งไม่เหนื่อย?", options:["นักกีฬา","รถ","เวลา","หมา"], correctIndex:2 },
  { topic:"pat_ing", cat:"😏 กวนประสาท", diff:"easy", text:"ถ้าคุณเดินเข้าป่าแล้วเจอทางแยก 2 ทาง แต่ไม่รู้ทางไหนกลับบ้าน คุณควรทำอย่างไร?", options:["เดาสุ่ม","โทรถามคนที่บ้าน","ร้องไห้","สร้างบ้านอยู่ตรงนั้น"], correctIndex:1 },
  { topic:"pat_ing", cat:"😏 กวนประสาท", diff:"hard", text:"ถ้าคุณกำลังถือร่ม แล้วร่มกลับด้านเพราะลม คุณจะทำอะไร?", options:["โยนทิ้ง","กลับร่ม","กางอีกคัน","โทษกรมอุตุฯ"], correctIndex:1 },
  { topic:"pat_ing", cat:"😏 กวนประสาท", diff:"medium", text:"อะไรยิ่งล้างยิ่งสกปรก?", options:["รถ","จาน","น้ำ","เสื้อ"], correctIndex:2 },
  { topic:"pat_ing", cat:"😏 กวนประสาท", diff:"easy", text:"อะไรมีหูแต่ไม่ได้ยิน?", options:["คน","หม้อ","หมา","แมว"], correctIndex:1 },
  { topic:"pat_ing", cat:"😏 กวนประสาท", diff:"hard", text:"ถ้าคุณตอบคำถาม PAT & ING ครบทั้ง 50 ข้อแล้ว สิ่งที่คุณควรทำคืออะไร?", options:["ดีใจ","เช็กคะแนน","ไปต่อ","สงสัยว่าทำไมชีวิตต้องมาเจออะไรแบบนี้"], correctIndex:3 },

  // ---- 🤔 สามัญสำนึก ----
  { topic:"pat_ing", cat:"🤔 สามัญสำนึก", diff:"medium", text:"ถ้าโยนหินสีแดงลงทะเล หินจะกลายเป็นอะไร?", options:["สีฟ้า","สีดำ","เปียก","ปลา"], correctIndex:2 },
  { topic:"pat_ing", cat:"🤔 สามัญสำนึก", diff:"hard", text:"เข้าไปในห้องมืด มีเทียน ตะเกียง และเตาแก๊ส คุณมีไม้ขีด 1 ก้าน จะจุดอะไรก่อน?", options:["เทียน","ตะเกียง","เตาแก๊ส","ไม้ขีด"], correctIndex:3 },
  { topic:"pat_ing", cat:"🤔 สามัญสำนึก", diff:"easy", text:"อะไรเอ่ย เดินได้แต่ไม่มีขา?", options:["นาฬิกา","รองเท้า","เวลา","รถ"], correctIndex:2 },
  { topic:"pat_ing", cat:"🤔 สามัญสำนึก", diff:"medium", text:"ถ้าคุณโยนลูกบอลขึ้นฟ้า แล้วมันตกลงมาเพราะอะไร?", options:["แรงโน้มถ่วง","ลม","มันเบื่อ","โลกเรียกกลับบ้าน"], correctIndex:0 },
  { topic:"pat_ing", cat:"🤔 สามัญสำนึก", diff:"easy", text:"อะไรเกิดก่อน ระหว่างไก่กับไข่?", options:["ไก่","ไข่","คนทำกับข้าว","แล้วแต่ร้านอาหาร"], correctIndex:1 },
  { topic:"pat_ing", cat:"🤔 สามัญสำนึก", diff:"medium", text:"ถ้าคุณมีแก้วน้ำเต็มแก้ว แล้วดื่มจนหมด คุณเหลืออะไร?", options:["น้ำ","แก้ว","ความกระหาย","ทุกข้อ"], correctIndex:1 },
  { topic:"pat_ing", cat:"🤔 สามัญสำนึก", diff:"easy", text:"ถ้าคุณปิดตา แล้วมองไม่เห็นอะไร แปลว่าอะไร?", options:["ตาบอด","ห้องมืด","คุณหลับ","แค่ปิดตาอยู่"], correctIndex:3 },
